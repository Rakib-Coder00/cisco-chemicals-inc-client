            ...
            <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
                <div class="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
                    <div class="self-start hidden lg:flex flex-col  text-white">
                        {/* <img src="" class="mb-3"> */}
                        <h1 class="mb-3 font-bold text-5xl">Hi 👋 Welcome To Cisco. </h1>
                            ...
                            <div class="space-y-5">
                                <div class="">
                                    ...
                                    <input
                                        ...
                                        class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="text" placeholder="Your Name" />
                                ...
                                <div>
                                    <input type="submit" value='Sign Up' class="w-full flex justify-center bg-green-400  hover:bg-green-500 text-gray-100 p-3 rounded-md tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500" />
                                </div>
                            </div>
                        </form>
